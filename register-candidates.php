            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob" min="1960-01-01" max="2090-01-31" name="dob" placeholder="Date Of Birth">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <label style="color: red;">Resume(PDF Only!)</label>
